...
public class restart_Enigme_3 : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip BruitagePas;
    ...
    private void reload_Dalle(Collider other)
    {
        ...
        nouvelleInstance.GetComponent<AudioSource>().clip = BruitagePas;
        nouvelleInstance.GetComponent<AudioSource>().volume = 0.5f;
    }
